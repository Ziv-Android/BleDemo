        ...
        android.app.AlertDialog alertDialog = new AlertDialog.Builder(context).setTitle("权限被禁用").setMessage(message).setCancelable(false)
                ...
                .setPositiveButton("去设置", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = PermissionSettingPage.getSmartPermissionIntent(context, permission);
...
//                        }
    ...
    public static class PermissionSettingPage {
        ...
        public static Intent getSmartPermissionIntent(Context context, List<String> deniedPermissions) {
            // 如果失败的权限里面不包含特殊权限
            if (deniedPermissions == null || deniedPermissions.isEmpty() || !containsSpecialPermission(deniedPermissions)) {
            ...
            if (isAndroid11() && deniedPermissions.size() == 3 &&
    ...
    public static PermissionUtil getInstance() {
        return PermissionUtil.SingleHolder.INSTANCE;
    }
}
